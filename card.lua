...
local function CreateToggle(parent, text, defaultState, indentLevel, callback)
	...
	local l = Instance.new("TextLabel", f); l.Size = UDim2.new(1, -50 - pLeft, 1, 0); l.Position = UDim2.new(0, pLeft, 0, 0); l.BackgroundTransparency = 1; l.Text = text; l.TextColor3 = isSub and ColorTextDim or ColorAccent; l.Font = isSub and Enum.Font.Gotham; l.TextSize = isSub and 11 or 12; l.TextXAlignment = Enum.TextXAlignment.Left
